...
- [ ] **INFR-02**: FastAPI backend exposes REST endpoints for all data, features, model outputs
- [ ] **INFR-03**: FastAPI uses SSE for streaming progress of long-running jobs (model training, backtesting)
- [ ] **INFR-04**: Redis caches expensive computations (Leontief inverse, model predictions, dashboard state)
